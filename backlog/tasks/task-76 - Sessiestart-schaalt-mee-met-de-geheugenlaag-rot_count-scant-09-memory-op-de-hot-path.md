...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 memory-notify leest de rot-telling af in plaats van 09-memory te scannen
- [ ] #2 De sessiestart-kosten van memory-notify groeien niet meer met het aantal memories; bewezen met een meting op de echte vault
- [ ] #3 De telling wordt ook bijgewerkt wanneer het embed/LLM-model onbereikbaar was
- [ ] #4 Ontbrekende telling laat de sessiestart niet alsnog scannen en breekt de melding niet
