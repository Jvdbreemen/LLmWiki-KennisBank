...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Bundle passes §11 conformance — automated fixture test (PyYAML as strict referee when available)
- [ ] #2 Trust-tier mapping verified (draft / process / human combinations)
- [ ] #3 Wikilinks converted; broken-link count reported
