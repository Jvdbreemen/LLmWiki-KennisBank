...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 The recall cost of the 4000-character cap is measured with kb-eval on existing question sets, not assumed
- [x] #2 If windowed indexing wins, it wins on a pre-registered rule stated before the run
- [x] #3 Whatever the outcome, the numbers are written down — including a loss
- [x] #4 The hot path stays sub-second: any added cost is paid at write time
