...
| `graph_retrieval` | uit | de `(buur)`-entry in de hook-injectie komt uit de gewogen graafindex `kb-graph.db` (submilliseconde; stale graaf → geen buur, zie doctor) | legacy wikilink-scan over artikelteksten levert de buur (gedrag van vóór TASK-87) |
