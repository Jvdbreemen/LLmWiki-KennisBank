...
een stem die voorkomt in tool-call-input (bv. een Read van dat artikel)
telt als gebruikt. Bewust NIET de user/hook-berichten scannen: de
injectie zelf bevat de stems per definitie en zou elke injectie als
"gebruikt" aanmerken. Assistant-tekst telt eveneens NIET mee: die is
bewust uit het signaal gehaald omdat een model dat een stem noemt nog
niets over het nut van het document zegt.
