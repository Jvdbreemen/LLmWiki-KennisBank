...
Event-capture helper used by the coordinated Copilot integration. Setup
registers it indirectly through the start and exit coordinators and directly
for prompt/tool events. The helper supports
